...
import { restaurentdatabase, restaurentdatabass } from './configirations/databse.config';
import { DATABASE_CONFIG } from './configirations/database.configfile';
import { DatabaseConfig } from './configirations/database.configure.service';
@Module({
